...
//	score = 37000 - score;
	score = 38000 - score; // mehr Zeit für Scoreanzeige die Coolie ist zu schnell

	sprintf(tscore,"%ld",score);
//	FBDrawString( 190, 210, 64, "Score", WHITE, 0 ); //Orginalanzeige in der Mitte des Minenfeldes
//	FBDrawString( 190, 290, 64, tscore, WHITE, 0 ); // 
	FBDrawString( 500, 210, 64, "Score", WHITE, 0 ); //Anzeige neben dem Minenfeld dort wo auch die "Game Over"-Anzeige erscheint!
	FBDrawString( 500, 290, 64, tscore, WHITE, 0 ); // 
}
