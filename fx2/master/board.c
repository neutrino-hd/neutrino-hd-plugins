...
static	int	lcount=0;
	...
	case RC_OK :
		...
		{
			doexit=1;
//			FBDrawString( 260, 37, 64, " great ", RED, 0 ); // orginal position of endtext
			FBDrawString( 260, 28, 60, " great ", RED, 0 ); // position of endtext, upper 9 px
			return;
		}
		for( i=0; i < 5; i++ )
		{
		...
		{
			doexit=2;
//			FBDrawString( 260, 37, 64, " you lost ", RED, 0 ); // orginal position of endtext
			FBDrawString( 260, 28, 60, " you lost ", RED, 0 ); // position of endtext, upper 9 px
			for( i=0; i < 5; i++ )
			{
