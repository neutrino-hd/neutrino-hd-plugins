...
static	Ghost	*ighosts[] = { ighost0, ighost1, ighost2, ighost3, ighost4, ighost5, ighost6, ighost7, ighost8, ighost9 };
...
static	unsigned char	*mazes[] = { maze0, maze1, maze2, maze3, maze4, maze5, maze6, maze7, maze8, maze9 };
...
void	DrawPac( void )
{
	...
	rstep = lstep + 10;
	FBCopyImage( pac.x*32+pac.x_minor, pac.y*32+pac.y_minor, 32, 32, pacs[ pac.step/2 ] );
